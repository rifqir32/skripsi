...
<body>
            ...
            <div class="card grey lighten-5">
                <div class="container">
                    <div class="card-content" height="800px">
                        <span class="card-title">Masukkan Nominal Donasi</span>     


                        <div class="input-field row">
                            <input id="icon_telephone" type="number" class="validate" class="validate">
                            <label for="icon_telephone">Jumlah Donasi Anda</label>
                        </div>
                ...
                <div class="card-action row">
                    <a href="#modal1" class="waves-effect waves-light btn">Donasi</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="page-footer  red darken-4">
        ...
        <div class="footer-copyright">
            <div class="container">2017 Copyright Turun Tangan Malang<a class="grey-text text-lighten-4 right" href="#!">More Links</a></div>
        </div>
