        ...
        <div class="row center">
            <div class="card grey lighten-5">
                ...
                <div class="card-action row">
                    <a href="#modal1" class="waves-effect waves-light btn">Submit Donasi</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col s12 m12 l8">
                            <table class="striped">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Deskripsi donasi</td>
                                        <td>ATK </td>
                                        <td>500 pak</td>
                                    </tr>
                                </tbody>
                            </table>
                            <p><b>silahkan kirim ke alamat ini</b></p>
                            <p>perumahan dwiga regency</p>
                            <p>blok 123</p>
                            <p>Atas nama: djafar ravensky</p>
                        </div>
          </div>
          <div class="modal-footer">
