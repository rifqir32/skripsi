        ...
        <div class=".col-md-6 .col-md-offset-3">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form role="form" action= "<?php echo base_url()."C_informasiProfil/tampilInformasiProfil" ?>">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputPassword1" placeholder="no hp">
                </div>
                <div class="form-group">
