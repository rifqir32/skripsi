        ...
        <div class=".col-md-6 .col-md-offset-3">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form role="form" action= "<?php echo base_url()."C_editInformasiProfil/editProfil" ?>">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama</label>
                  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Rahmat Darmawan" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Boyolali</label>
                  <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Boyolali"readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" id="exampleInputPassword1" placeholder="donatur@gmail.com"readonly>
                </div>
