  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo base_url()."Kewirausahaan/"; ?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        <li class="active"><a href="<?php echo base_url()."Kewirausahaan/mengelola_donasi"; ?>"><i class="fa fa-heart"></i> <span>Donasi</span></a></li>
        <li class="active"><a href="<?php echo base_url()."Kewirausahaan/mengelola_donatur"; ?>"><i class="fa fa-black-tie"></i> <span>Donatur</span></a></li>
        <li class="treeview">
          <a href="#"><i class="fa fa-shopping-cart"></i> <span>Kelola Garage Sale</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."Kewirausahaan/tambah_barang_garage_sale"; ?>"><i class="fa fa-plus-square"></i> Tambah Barang</a></li>
            <li><a href="<?php echo base_url()."Kewirausahaan/mengelola_garage_sale"; ?>"><i class="fa fa-cubes"></i> Kelola Barang</a></li>
