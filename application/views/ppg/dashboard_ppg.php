  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kelola Kegiatan</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="small-box bg-aqua">
            ...
            <a href="#" class="small-box-footer">
              Lihat Seluruh Donasi <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
          <!-- /.info-box -->
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="small-box bg-aqua">
            ...
            <a href="#" class="small-box-footer">
              Lihat Seluruh Volunteer <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
          <!-- /.info-box -->
        </div>
        ...
        <div class="col-md-4">
          ...
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Barang Garage Sale</span>
