  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo base_url()."PPG/"; ?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        <li class="treeview">
          <a href="<?php echo base_url()."PPG/mengelola_kegiatan"; ?>"><i class="fa fa-list-alt"></i> <span>Kelola Kegiatan</span>
