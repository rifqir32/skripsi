  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active">
          <a href="<?php echo base_url()."C_informasiProfil/tampilInformasiProfilRelawan"; ?>"><i class="fa fa-list-alt"></i> <span>Informasi Profil</span>
          </a>
         
        </li>
        <li class="treeview">
          <a href="<?php echo base_url()."C_kelolaKegiatanRelawan/tampilKegiatanRelawan"; ?>"><i class="fa fa-book"></i> <span>Kegiatan</span>
